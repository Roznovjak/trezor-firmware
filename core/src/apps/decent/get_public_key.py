...
from trezor.messages.DecentGetPublicKey import DecentGetPublicKey
from trezor.messages.DecentPublicKey import DecentPublicKey

from apps.common import paths
from apps.decent import CURVE
from apps.decent.helpers import base58_encode, validate_full_path
from apps.decent.layout import require_get_public_key
...
def _public_key_to_wif(pub_key: bytes) -> str:
    ...
    return base58_encode("DCT", "", compressed_pub_key)
...
async def get_public_key(ctx, msg: DecentGetPublicKey, keychain):
    ...
    return DecentPublicKey(wif, public_key)
